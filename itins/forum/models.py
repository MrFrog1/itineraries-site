...
from customers.models import Agent  # Import your Agent model
...
class ForumTopic(models.Model):
    ...
    created_by = models.ForeignKey(Agent, related_name='topics', on_delete=models.CASCADE)
...
class ForumPost(models.Model):
    ...
    created_by = models.ForeignKey(Agent, related_name='posts', on_delete=models.CASCADE)
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
