...
// This one needs to be a way to add a hotels 1p 2p ep map cp etc into the database quickly
// One option is to flil out a whole table
// The other is to add 1p ep, add meal prices and then meal tax, food tax, discount, discouint exclusive of tax?


// class ExternalHotelForm extends Component {
//     state = {
//         guest: '',
//         hotel: '',
//         check_in: '',
...
// export default connect(null, { AddBooking})(ExternalHotelForm);
